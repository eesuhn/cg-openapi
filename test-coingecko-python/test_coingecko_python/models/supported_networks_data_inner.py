...
class SupportedNetworksDataInner(BaseModel):
    """
    SupportedNetworksDataInner
    """ # noqa: E501
    id: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    attributes: Optional[SupportedNetworksDataInnerAttributes] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": SupportedNetworksDataInnerAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None
        })
        return _obj
